...
export class Asignatura{
    ...
    /**
     * @function
     * @returns {Object} Asignatura en formato JSON.
     * @description Devuelve la asignatura en formato JSON.
     */
    toJSON() {
        return {
            nombre: this.#nombre,
            calificaciones: [...this.#calificaciones] // Copia las calificaciones para evitar modificar el array original
        };
    }
